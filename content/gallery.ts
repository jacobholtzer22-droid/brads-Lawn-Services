...
export const galleryItems: GalleryItem[] = [
  ...
  /* ---- aeration drop ---- */
  { slot: "aerPlugsHand", category: "Aeration" },
  { slot: "aerPlugsHandClose", category: "Aeration" },
  { slot: "aerTineCore", category: "Aeration" },
  { slot: "aerTinesPlugs", category: "Aeration" },
  { slot: "aerPlugAndHole", category: "Aeration" },
  { slot: "aerHandPointing", category: "Aeration" },
  { slot: "aerPlugsTurf", category: "Aeration" },
  { slot: "aerPlugsSpread", category: "Aeration" },
  { slot: "aerPlugsDense", category: "Aeration" },
  { slot: "aerLawnResult", category: "Aeration" },
  { slot: "aerLawnRows", category: "Aeration" },
  { slot: "aerLawnStriped", category: "Aeration" },
  { slot: "aerLawnWide", category: "Aeration" },
  { slot: "aerLawnSeeded", category: "Aeration" },
  { slot: "aerLawnOpen", category: "Aeration" },
  { slot: "aerLawnStrip", category: "Aeration" },
  { slot: "aerControlsBranded", category: "Aeration" },
  { slot: "aerMachineLawn", category: "Aeration" },
  { slot: "aerMachineProfile", category: "Aeration" },
  { slot: "aerMachineClean", category: "Aeration" },
  { slot: "aerMachineFront", category: "Aeration" },
  { slot: "aerDrumGrass", category: "Aeration" },
  { slot: "aerDrumTines", category: "Aeration" },
  { slot: "aerTinesWorking", category: "Aeration" },
  { slot: "aerDrumRaised", category: "Aeration" },
  { slot: "aerHopperSeed", category: "Aeration" },
  { slot: "aerSeederLoaded", category: "Aeration" },
  { slot: "aerSeederBox", category: "Aeration" },
  { slot: "aerCrewBrandedShirt", category: "Aeration" },
  { slot: "aerCrewMachine", category: "Aeration" },
  { slot: "aerCrewSpringLawn", category: "Aeration" },
  { slot: "aerCrewSidewalk", category: "Aeration" },
  { slot: "aerCrewRiding", category: "Aeration" },
  { slot: "aerLoadingTrailer", category: "Aeration" },
  { slot: "aerCrewFieldFront", category: "Aeration" },
  { slot: "aerCrewFieldPass", category: "Aeration" },
  { slot: "aerFieldStripes", category: "Aeration" },
  { slot: "aerFieldWide", category: "Aeration" },
  { slot: "aerFieldGreen", category: "Aeration" },
  { slot: "aerFieldDiamond", category: "Aeration" },
  { slot: "equipFleetYard", category: "Equipment" },
  { slot: "equipTrucksTrailers", category: "Equipment" },
  { slot: "equipAeratorDetail", category: "Equipment" },
  { slot: "equipAeratorSide", category: "Equipment" },
  { slot: "equipAeratorRear", category: "Equipment" },
  { slot: "equipAeratorTurf", category: "Equipment" },
  { slot: "equipAeratorHopper", category: "Equipment" },
  { slot: "aerYardSign", category: "Aeration" },
  { slot: "aerSignTruck", category: "Aeration" },
  { slot: "aerTurfGreen", category: "Lawn Care" },
  { slot: "aerTurfRecovered", category: "Lawn Care" },
  { slot: "aerTurfThin", category: "Aeration" },
  { slot: "aerTurfSeeded", category: "Aeration" },
  { slot: "aerTurfFill", category: "Aeration" },
  { slot: "aerTurfDormant", category: "Aeration" },
